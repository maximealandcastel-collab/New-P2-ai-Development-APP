...
class UsersInvoicePreviewScreen extends StatelessWidget {
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          'This invoice is a service summary generated by ${TenantBrandService.to.displayName}. This is not a direct insurance claim document. Please contact your facility administrator for official tax documents.',
  ...
  Future<void> _shareInvoice() async {
    await SharePlus.instance.share(
      ShareParams(
        text: '${TenantBrandService.to.displayName} invoice INV-2456-524\nTotal billed: \$184.00',
