...
class _NavBarState extends State<NavBar> {
  BottomNavBarController get _navBarController => BottomNavBarController.to;
  String _role = '';
  ...
  void _loadRole() {
    final isTrainer = LoginController.to.isTrainer();
    setState(() => _role = isTrainer ? 'Trainer' : 'User');
  }
