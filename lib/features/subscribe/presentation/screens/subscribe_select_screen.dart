        ...
        child: Column(
          children: [
            ...
            Obx(() => SubscribeOptionCard(
              ...
              description:
              'Get access to a certified trainer assigned by the app. Enjoy personalized workout guidance and continuous support at an affordable monthly price.',
            ...
            Obx(() => SubscribeOptionCard(
              ...
              description:
              'Select your preferred trainer and receive a customized fitness plan tailored to your goals, schedule, and training preferences.',
