...
class ClientDetailsScreen extends StatelessWidget {
    ...
    return CustomContainer(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomButton(
            onPressed: () =>
                _showMessage(context, 'Session details are not available yet.'),
            label: "View details",
                ...
                child: CustomButton(
                  onPressed: () => Get.dialog(
                    AlertDialog(
                      ...
                      content: const Text(
                        'Consider reducing squat weight by 10% and adding 5 minutes of focused hip mobility warm-ups.',
                      ),
                      actions: [
              ...
              Expanded(
                child: CustomButton(
                  onPressed: () => _showMessage(
                    context,
                    'Applying AI suggestions is not connected yet.',
                  ),
  ...
  Widget _buildDailyToDo(BuildContext context) {
    return CustomContainer(
      paddingAll: 16.r,
      radiusAll: 16.r,
      color: Colors.white,
      child: Column(
        children: [
          ...
          CustomButton(
            onPressed: () => _showMessage(
              context,
              'The complete daily to-do list is not available yet.',
            ),
            label: "View all",
            backgroundColor: Colors.white,
            foregroundColor: Colors.black,
